...
aws s3api put-bucket-website --bucket rjm-simple-web-site1 --website-configuration file://${TMP_CFG_FILE}
...
aws s3api put-bucket-policy --bucket rjm-simple-web-site1 --policy file://${TMP_CFG_FILE}
