...
def subscribe_to_topic_for_email(topicname) :
	...
	if arn == "" :
		...
		print("Subscribing to topic:", topicname, "arn =", arn)

		response = sns_client.subscribe(
			TopicArn = arn,
			Protocol = 'email',
			Endpoint = 'rjmeats@hotmail.com',		# No restriction on what this is, could send to anyone!
...
if __name__ == "__main__" :
	print(sns_client)
	print()
	subscribe_to_topic_for_email('test_topic2')
	print()
